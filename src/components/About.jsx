      ...
      <Stack gap={2}>
        <Card sx={{ backgroundColor: "background.paper", border:1, borderColor:"rgba(255,255,255,.08)" }}>
          <CardContent>
            ...
            <Typography sx={{ opacity: .9 }}>
              SNAPP is a lightweight NFL schedule & matchup viewer. Browse games by week, tap a matchup,
        ...
        <Card sx={{ backgroundColor: "background.paper", border:1, borderColor:"rgba(255,255,255,.08)" }}>
          <CardContent>
            ...
            <Divider sx={{ mb: 2 }} />
            <Typography sx={{ mb: 1 }}>
              SNAPP computes a simple estimate for the home team’s win chance using past completed games:
            </Typography>
